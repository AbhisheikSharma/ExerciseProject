...
public class UserCreationProductCreationAndSearches extends RequiredCapabilities {
	...
	ExtentTest test;
	private static final Logger log = LogManager.getLogger(UserCreationProductCreationAndSearches.class.getName());
	...
	public void createNewUser() {
		...
		test.log(LogStatus.PASS,
				"New User Created Successfully - We cannot go beyond submission as we are getting some exception on submitting flow");
		log.info("Custom log message will be logged in the log file with help from apache packages");
	...
	public void searchFeaturedProduct(String bookname) {
		...
		log.debug("Custom log message will be logged in the log file with help from apache packages");
